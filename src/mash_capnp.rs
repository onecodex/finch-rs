...
pub mod min_hash {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_reference_list_old(self) -> ::capnp::Result<::mash_capnp::min_hash::reference_list::Reader<'a>> {
    ...
    #[inline]
    pub fn get_locus_list(self) -> ::capnp::Result<::mash_capnp::min_hash::locus_list::Reader<'a>> {
    ...
    #[inline]
    pub fn get_reference_list(self) -> ::capnp::Result<::mash_capnp::min_hash::reference_list::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_reference_list_old(self) -> ::capnp::Result<::mash_capnp::min_hash::reference_list::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
    }
    #[inline]
    pub fn set_reference_list_old<'b>(&mut self, value: ::mash_capnp::min_hash::reference_list::Reader<'b>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
    }
    #[inline]
    pub fn init_reference_list_old(self, ) -> ::mash_capnp::min_hash::reference_list::Builder<'a> {
    ...
    #[inline]
    pub fn get_locus_list(self) -> ::capnp::Result<::mash_capnp::min_hash::locus_list::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1))
    }
    #[inline]
    pub fn set_locus_list<'b>(&mut self, value: ::mash_capnp::min_hash::locus_list::Reader<'b>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(1), value)
    }
    #[inline]
    pub fn init_locus_list(self, ) -> ::mash_capnp::min_hash::locus_list::Builder<'a> {
    ...
    #[inline]
    pub fn set_alphabet(&mut self, value: ::capnp::text::Reader)  {
    ...
    #[inline]
    pub fn get_reference_list(self) -> ::capnp::Result<::mash_capnp::min_hash::reference_list::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(3))
    }
    #[inline]
    pub fn set_reference_list<'b>(&mut self, value: ::mash_capnp::min_hash::reference_list::Reader<'b>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(3), value)
    }
    #[inline]
    pub fn init_reference_list(self, ) -> ::mash_capnp::min_hash::reference_list::Builder<'a> {
  ...
  impl Pipeline  {
    pub fn get_reference_list_old(&self) -> ::mash_capnp::min_hash::reference_list::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(0))
    }
    pub fn get_locus_list(&self) -> ::mash_capnp::min_hash::locus_list::Pipeline {
      ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(1))
    }
    pub fn get_reference_list(&self) -> ::mash_capnp::min_hash::reference_list::Pipeline {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xd9d16806af782606;
  }
  ...
  pub mod reference_list {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_references(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,::mash_capnp::min_hash::reference_list::reference::Owned>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0))
      }
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_references(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,::mash_capnp::min_hash::reference_list::reference::Owned>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
      }
      #[inline]
      pub fn set_references(&mut self, value: ::capnp::struct_list::Reader<'a,::mash_capnp::min_hash::reference_list::reference::Owned>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
      }
      #[inline]
      pub fn init_references(self, size: u32) -> ::capnp::struct_list::Builder<'a,::mash_capnp::min_hash::reference_list::reference::Owned> {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0xcf71219d02db7ad0;
    }
    ...
    pub mod reference {
      ...
      impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_sequence(&mut self, value: ::capnp::text::Reader)  {
        ...
        #[inline]
        pub fn set_quality(&mut self, value: ::capnp::text::Reader)  {
      ...
      mod _private {
        ...
        pub const TYPE_ID: u64 = 0x96c3ea4cbfe143bf;
      }
    }
  }
  ...
  pub mod locus_list {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_loci(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,::mash_capnp::min_hash::locus_list::locus::Owned>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0))
      }
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_loci(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,::mash_capnp::min_hash::locus_list::locus::Owned>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
      }
      #[inline]
      pub fn set_loci(&mut self, value: ::capnp::struct_list::Reader<'a,::mash_capnp::min_hash::locus_list::locus::Owned>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
      }
      #[inline]
      pub fn init_loci(self, size: u32) -> ::capnp::struct_list::Builder<'a,::mash_capnp::min_hash::locus_list::locus::Owned> {
        ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
      }
      pub fn has_loci(&self) -> bool {
        !self.builder.get_pointer_field(0).is_null()
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 1 };
      pub const TYPE_ID: u64 = 0xe1ddf186e2b359dd;
    }
    ...
    pub mod locus {
      ...
      mod _private {
        ...
        pub const TYPE_ID: u64 = 0xa648d7188f2259f6;
      }
    }
  }
}
