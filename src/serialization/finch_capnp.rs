...
pub mod filter_params {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_low_abun_filter(self) -> u64 {
            self.reader.get_data_field::<u64>(1)
        }
        #[inline]
        pub fn get_high_abun_filter(self) -> u64 {
    ...
    impl<'a> Builder<'a> {
        ...
        #[inline]
        pub fn set_low_abun_filter(&mut self, value: u64) {
        ...
        #[inline]
        pub fn set_high_abun_filter(&mut self, value: u64) {
